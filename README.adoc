...
(6) https://github.com/DigitalSal/cdf-workshop-aws/blob/master/ranger-config.adoc[Ranger Policies Configured]
...
image::./images/step0/RefArch.png[]
...
Example +
`amer-smm-cluster-corebroker1.amer-wor.dp5i-5vkq.cloudera.site:9093` +
`amer-smm-cluster-corebroker0.amer-wor.dp5i-5vkq.cloudera.site:9093` +
`amer-smm-cluster-corebroker2.amer-wor.dp5i-5vkq.cloudera.site:9093` +
...
`Kafka Broker Endpoint`: The list of Kafka Brokers previously noted, which is comma separated as shown below. +
		*Example*: `amer-smm-cluster-corebroker1.amer-wor.dp5i-5vkq.cloudera.site:9093, amer-smm-cluster-corebroker0.amer-wor.dp5i-5vkq.cloudera.site:9093, amer-smm-cluster-corebroker2.amer-wor.dp5i-5vkq.cloudera.site:9093` +
...
`Schema Registry Hostname`: The hostname of the master server in the Kafka Datahub (Ex: `amer-smm-cluster`) (Refer screenshot below). +
*Example*: `amer-smm-cluster-master0.amer-wor.dp5i-5vkq.cloudera.site` +
...
`amer-smm-cluster-corebroker1.amer-wor.dp5i-5vkq.cloudera.site:9093, amer-smm-cluster-corebroker0.amer-wor.dp5i-5vkq.cloudera.site:9093, amer-smm-cluster-corebroker2.amer-wor.dp5i-5vkq.cloudera.site:9093` +
